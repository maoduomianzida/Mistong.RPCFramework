...
namespace Mistong.Services.OrderService
{
  public partial class OrderService {
    public interface ISync {
      OrderInfo @Get(int orderId);
    }

    public interface Iface : ISync {
      #if SILVERLIGHT
      IAsyncResult Begin_Get(AsyncCallback callback, object state, int orderId);
      OrderInfo End_Get(IAsyncResult asyncResult);
      #endif
    }
    ...
    public class Client : IDisposable, Iface {
      ...
      #if SILVERLIGHT
      public IAsyncResult Begin_Get(AsyncCallback callback, object state, int orderId)
      {
        return send_Get(callback, state, orderId);
      }

      public OrderInfo End_Get(IAsyncResult asyncResult)
      {
      ...
      #if SILVERLIGHT
      public IAsyncResult send_Get(AsyncCallback callback, object state, int orderId)
      #else
      public void send_Get(int orderId)
      #endif
      {
    ...
    public class Processor : TProcessor {
      ...
      public void Get_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        try
        {
          result.Success = iface_.@Get(args.OrderId.Value);
    ...
    public partial class Get_result : TBase
    {
      ...
      public OrderInfo Success { get; set; }
